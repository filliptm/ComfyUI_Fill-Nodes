...
class FL_AnimeLineExtractor:
    ...
    def extract_lines(self, image, line_threshold, line_width, detail_level, noise_reduction):
    ...
    def _process_single_image(self, img, line_threshold, line_width, detail_level, noise_reduction):
